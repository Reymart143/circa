                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="h5 modal-title text-center">
                                        ...
                                        <span class="badge badge-success text-white">Register PORTAL</span>
                                    </div>
                                    <form id="loginForm" method="POST" action="{{ route('register.store')}}">
                                        ...
                                        <div class="form-row">
                                            <div class="row">
                                                     <div class="col-md-4">
                                                <label for="username" class="fa fa-user"> First Name</label>
                                                <div class="position-relative form-group">
                                                    <input name="f_name" id="f_name" placeholder="Input First Name here..." type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="username" class="fa fa-user"> Middle Name</label>
                                                <div class="position-relative form-group">
                                                    <input name="m_name" id="m_name" placeholder="Input Middle Name here..." type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="username" class="fa fa-user"> Last Name</label>
                                                <div class="position-relative form-group">
                                                    <input name="l_name" id="l_name" placeholder="Input Last Name here..." type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            </div>
                                           
                                            <div class="col-md-12">
                                                <label for="username" class="fa fa-user"> Create your Username</label>
                                                <div class="position-relative form-group">
                                                    <input name="username" id="username" placeholder="Input Username here..." type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="password" class="fa fa-lock"> Create your Password</label>
                                                <div class="position-relative form-group">
                                        ...
                                        <div class="float-right">
                                            ...
                                            <button class="btn btn-shadow btn-gradient-primary btn-lg" type="submit">Register Now</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
