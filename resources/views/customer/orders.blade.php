        ...
        @if(Auth::check())
            <div>
                <span class="description-title" style="
                    ...
                    border-radius: 10px;
                ">
                   Please finalize your order Maam/Sir , <small>{{ Auth::user()->f_name }}</small> 
                </span>
            </div>
        @endif

        <a href="/menu" class="btn btn-warning" style="font-weight: bold; padding: 10px 20px;margin-right:2%">Order More</a>
    </div>
